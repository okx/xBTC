...
contract TestXSOL is Script {
    ...
    function run() external {
        ...
        console.log("\n=== Starting xSOL Comprehensive Test ===\n");
    ...
    function deployContracts() internal {
        ...
        bytes memory initData = abi.encodeCall(
            ...
            (
                ...
                1_000_000_000 * 10 ** 9  // 1B with 9 decimals
            )
        );
    ...
    function testReadFunctions() internal view {
        ...
        require(keccak256(bytes(name)) == keccak256(bytes("xSOL")), "Name mismatch");
        
        // Test symbol()
        string memory symbol = token.symbol();
        console.log("symbol():", symbol);
        require(keccak256(bytes(symbol)) == keccak256(bytes("xSOL")), "Symbol mismatch");
        
        // Test decimals()
        uint8 decimals = token.decimals();
        console.log("decimals():", decimals);
        require(decimals == 9, "Decimals mismatch");
        ...
        require(maxSupply == 1_000_000_000 * 10 ** 9, "Max supply mismatch");
    ...
    function testMinting() internal {
        ...
        uint256 mintAmount = 1000 * 10 ** 9;  // 1000 xSOL (9 decimals)
    ...
    function testTransfers() internal {
        ...
        uint256 transferAmount = 100 * 10 ** 9;  // 100 xSOL (9 decimals)
    ...
    function testApprovals() internal {
        ...
        uint256 approveAmount = 50 * 10 ** 9;  // 50 xSOL (9 decimals)
        ...
        uint256 transferAmount = 30 * 10 ** 9;  // 30 xSOL (9 decimals)
    ...
    function testBurning() internal {
        ...
        uint256 burnAmount = 50 * 10 ** 9;  // 50 xSOL (9 decimals)
